...
public class MainApplet extends javax.swing.JApplet
{
	...
	/**
	 * Initializes the applet MainApplet Initialises all fields
	 */
	public void init()
	{
		try
...
//					String keepDoubleNumbersStr = getParameter("displayDecimalNumbers");
			...
			String keepDoubleNumbersStr = null;
					...
					if(keepDoubleNumbersStr != null
							&& (keepDoubleNumbersStr.equals("True") || keepDoubleNumbersStr.equals("true")))
					{
				...
				//	appletCodeBase = getCodeBase();
					try
					{
						appletCodeBase = new URL("file:" + System.getProperty("user.dir") + "\\");
					}
					catch (Exception e)
					{
						e.printStackTrace();
					}
					//String s = appletCodeBase.toString();
					 //JOptionPane.showMessageDialog(null, s, "DEBUG...", JOptionPane.ERROR_MESSAGE);
					...
					addComponent = new AddComponent(inputComponents, jPanelWorkspace, buildTree, textBoxListener,
							statusBar, langMan, implicitMult, keepDoubleNumbers);

					// Set tabs icons
					jTabbedPaneInput.setTitleAt(0, "");
					jTabbedPaneInput.setIconAt(0,
							new javax.swing.ImageIcon(getClass().getResource("/Display/Images/operators.gif")));
					jTabbedPaneInput.setTitleAt(1, "");
					jTabbedPaneInput.setIconAt(1,
							new javax.swing.ImageIcon(getClass().getResource("/Display/Images/layout.gif")));
					jTabbedPaneInput.setTitleAt(2, "");
					jTabbedPaneInput.setIconAt(2,
							new javax.swing.ImageIcon(getClass().getResource("/Display/Images/fences.gif")));
					jTabbedPaneInput.setTitleAt(3, "");
					jTabbedPaneInput.setIconAt(3,
							new javax.swing.ImageIcon(getClass().getResource("/Display/Images/sin.gif")));
					jTabbedPaneInput.setTitleAt(4, "");
					jTabbedPaneInput.setIconAt(4,
							new javax.swing.ImageIcon(getClass().getResource("/Display/Images/calculus.gif")));
					jTabbedPaneInput.setTitleAt(5, "");
					jTabbedPaneInput.setIconAt(5,
							new javax.swing.ImageIcon(getClass().getResource("/Display/Images/greek.gif")));
					jTabbedPaneInput.setTitleAt(6, "");
					jTabbedPaneInput.setIconAt(6,
							new javax.swing.ImageIcon(getClass().getResource("/Display/Images/arrows.gif")));
					...
					jPanelWorkspace.addMouseListener(new java.awt.event.MouseAdapter()
					{
						public void mouseClicked(java.awt.event.MouseEvent evt)
						{
							...
							else
							{
								...
								addComponent(false, SwingUtilities.convertPoint(evt.getComponent(), evt.getPoint(),
										jPanelWorkspace));
							}
						}
					});
	...
	public void loadConfigFile()
	{
		...
		try
		{
			componentFile = builder.build(this.getClass().getResourceAsStream("/Displayx/CompConfig.xml"));
			inpComps = componentFile.getRootElement();
		}
		catch (IOException ex)
		{
			JOptionPane.showMessageDialog(null, "Error loading internal component file - please correct", "DragMath",
	...
	/**
	 * Adds a MouseListener to each JButton in each toolbar in the palette, and
	 * creates a JLabel for each JButton, and stores it in the
	 * <code>labels</code> array.
	 * 
	 * @param components
	 *            the array of toolbars, each containing JButtons
	 */
	 ...
	 * 
	 * @param components
	 *            the array of components on the toolbar
	 */
	...
	public void addToComponentArray(String name)
	{
		...
		else
		{
			try
			{
				originalImage = ImageIO
						.read(getClass().getResource("/Display/Images/" + comp.getAttributeValue("iconFileName")));
			}
			catch (IOException ex)
			{
				ex.printStackTrace();
		...
		inputComponents[addComponent.getID(name)] = new InputComponent(Integer.parseInt(comp.getAttributeValue("ID")),
				Integer.parseInt(comp.getAttributeValue("group")), comp.getText(),
				langMan.readLangFile(addComponent.getName(name)), newCursor, name, originalImage);
	}
	...
	public String getMathExpression()
	{
		...
		{
			JOptionPane.showMessageDialog(null, langMan.readLangFile(output.getOutputFormat()) + ex.getMessage(),
	...
	private void initComponents()
	{
		...
		jButtonClear
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Display/Images/new_document_24_h.png")));
		...
		jButtonLoad
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Display/Images/open_document_24_h.png")));
		...
		jButtonCopy
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Display/Images/copy_clipboard_24_h.png")));
		...
		jButtonPaste
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Display/Images/paste_clipboard_24_h.png")));
		...
		jButtonExport
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Display/Images/move_to_folder_24_h.png")));
		...
		jMenuItemSelectAll.setAccelerator(
	...
	{//GEN-FIRST:event_jCheckBoxImplicitMultActionPerformed
	...
	{//GEN-FIRST:event_jButtonLoadActionPerformed
			// TODO add your handling code here:
	}//GEN-LAST:event_jButtonLoadActionPerformed

	private void jButtonClearMouseClicked(java.awt.event.MouseEvent evt)
	{//GEN-FIRST:event_jButtonClearMouseClicked
		jPanelWorkspace.removeAll();
		jPanelWorkspace.revalidate();
	...
	{//GEN-FIRST:event_jMenuItemExportToImageActionPerformed
		String expression = "Failed to get expression";
		...
		try
		{
			...
			String answer = null;
			answer = (String) JOptionPane.showInputDialog(null, langMan.readLangFile("ImageSize"), "DragMath",
			...
			if(answer != null)
			{
				try
				{
					appletContext.showDocument(
							new java.net.URL(
									"http://www.mathtran.org/cgi-bin/mathtran?" + "D=" + answer + ";tex=" + expression),
							"_blank");
				}
				catch (Exception ex)
				{
					JOptionPane.showMessageDialog(null, langMan.readLangFile("Image"), "DragMath",
							JOptionPane.ERROR_MESSAGE);
				}
			}
		...
		{
			JOptionPane.showMessageDialog(null, langMan.readLangFile("Latex") + ex.getMessage(), "DragMath",
					JOptionPane.ERROR_MESSAGE);
		}
	...
	{//GEN-FIRST:event_jMenuItemSetLangActionPerformed
	...
	{//GEN-FIRST:event_jMenuItemSetExportActionPerformed
	...
	{//GEN-FIRST:event_jCheckBoxMenuItemShowOutlineActionPerformed
	...
	{//GEN-FIRST:event_jMenuItemPasteActionPerformed
		addComponent.paste();
	...
	{//GEN-FIRST:event_jMenuItemCopyActionPerformed
		...
		{
			JOptionPane.showMessageDialog(null, langMan.readLangFile("Copy") + ex.getMessage(), "DragMath",
					JOptionPane.ERROR_MESSAGE);
		}
	}//GEN-LAST:event_jMenuItemCopyActionPerformed

	private void jMenuItemCutActionPerformed(java.awt.event.ActionEvent evt)
	{//GEN-FIRST:event_jMenuItemCutActionPerformed
		try
		{
		...
		{
			JOptionPane.showMessageDialog(null, langMan.readLangFile("Cut") + ex.getMessage(), "DragMath",
					JOptionPane.ERROR_MESSAGE);
		}
	...
	{//GEN-FIRST:event_jMenuItemSaveAsActionPerformed
		saveAsFile();
		;
	...
	{//GEN-FIRST:event_jMenuItemOnlineHelpActionPerformed
		try
		{
	...
	{//GEN-FIRST:event_jButtonCopyMouseClicked
		try
		{
			addComponent.copy(jPanelWorkspace, buildTree);
		}
	...
	public void saveAsFile()
	{
		...
		if(returnVal == JFileChooser.APPROVE_OPTION)
		{
			...
			{
				JOptionPane.showMessageDialog(null, langMan.readLangFile("SavingExp"), "DragMath",
						JOptionPane.ERROR_MESSAGE);
			}
			catch (ParseException ex)
			{
	...
	public void openFile()
	{
		...
		if(returnVal == JFileChooser.APPROVE_OPTION)
		{
			...
			try
			{
				...
				ObjectInputStream expressionFile = new ObjectInputStream(
			...
			{
				JOptionPane.showMessageDialog(null, langMan.readLangFile("LoadingExp"), "DragMath",
						JOptionPane.ERROR_MESSAGE);
			}
	...
	/**
	 * Sets the borders of all components in the display to red for JPanel,
	 * green for JLabel and blue for <code>TextBox</code>, or sets all the
	 * borders to none
	 * 
	 * @param borders
	 *            boolean to say whether to add borders or remove them
	 * @param layer
	 *            JComponent that contains the components to set the borders on
	 */
	...
	/**
	 * Determines where to add the chosen component in the display depending
	 * upon where the mouse has been clicked or released.
	 */
	public void addComponent(boolean emptyWorkspace, Point mousePos)
	{
		...
		if(mousePos.getX() < 0 || mousePos.getX() > jPanelWorkspace.getWidth() || mousePos.getY() < 0
				|| mousePos.getY() > jPanelWorkspace.getHeight())
		{
			mousePos = null;
		}
			...
			if(add)
			{
				...
				if(group == AddComponent.LAYOUT)
				{
					...
					if(ID == 9)
					{
						...
						matrix_m = (String) JOptionPane.showInputDialog(null, langMan.readLangFile("EnterRows"),
								langMan.readLangFile("MatrixDim"), JOptionPane.QUESTION_MESSAGE, null, values, "1");
						if(matrix_m == null)
						{
							cancel = true;
						}
						...
						if(cancel == false)
						{
							matrix_n = (String) JOptionPane.showInputDialog(null, langMan.readLangFile("EnterColumns"),
									langMan.readLangFile("MatrixDim"), JOptionPane.QUESTION_MESSAGE, null, values, "1");
							if(matrix_n == null)
							{
								cancel = true;
						...
						if(cancel == false)
						{
							addComponent.addLayout(layer, n, newComponent, status, layoutPanel,
									Integer.parseInt(matrix_m), Integer.parseInt(matrix_n), null);
						}
					}
					else
					{
	...
	/**
	 * This class listens for mouse clicks on the TextBox object, and sets the
	 * cursor icon
	 */
	 ...
	 * 
	 * @param layer
	 *            The current JPanel to look for selected components in
	 * @param componentFound
	 *            Boolean to say whether or not any selected components have
	 *            been found, set to false when first called
	 */
	...
	/**
	 * Class that extends MouseAdapter and listens for MouseEvents on the
	 * JButtons in the toolbars
	 */
	class MouseListenerPaletteToolbar extends MouseAdapter
	{
		...
		public void mousePressed(MouseEvent e)
		{
			...
			{
				dragging = false;
				JComponent focusComp = (JComponent) KeyboardFocusManager.getCurrentKeyboardFocusManager()
						.getFocusOwner();
			...
			else
			{
				...
				if(newComponent.getID() != 9 && newComponent.getID() != 29)
				{
					...
					catch (ParseException ex)
					{
						...
						{
							JOptionPane.showMessageDialog(null, langMan.readLangFile("Action") + ex.getMessage(),
									"DragMath", JOptionPane.ERROR_MESSAGE);
						}
					...
					if(selectionValid)
					{
						...
						if(selectionObjects.getComponentCount() > 0)
						{
							...
							if(group == AddComponent.LAYOUT)
							{
								addComponent.addLayout(selectionLayer, firstLocation, newComponent, 3, false, 0, 0,
										selectionObjects);
							}
							// group is operator
							if(group == AddComponent.NARY || group == AddComponent.BINARY)
							{
								...
								if(newComponent.getID() == 3)
								{
									...
									if(firstLocation > 0 && addComponent
											.getID(selectionLayer.getComponent(firstLocation - 1).getName()) == 2)
									{
										selectionLayer.remove(firstLocation - 1);
										selectionLayer.add(addComponent.createSymbol(inputComponents[3]),
												firstLocation - 1);
										addComponent.addGrouping(selectionLayer, firstLocation, inputComponents[31], 3,
												false, selectionObjects);
									} // Add unary minus
									else
									{
										newComponent = inputComponents[30];
										addComponent.addFunction(selectionLayer, firstLocation, newComponent, 3, false,
												selectionObjects);
									}
								}
								else
								{
									addComponent.addOperator(selectionLayer, firstLocation, newComponent, 3, false,
											selectionObjects);
								}
							}
							// group is function
							...
							if(group == AddComponent.GROUPING)
							{
								addComponent.addGrouping(selectionLayer, firstLocation, newComponent, 3, false,
										selectionObjects);
							}
							dragging = false;
