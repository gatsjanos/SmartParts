...
public class Snip_Hatvany
{
	...
	private void initialize()
	{
		...
		frame.setBounds(100, 100, 172, 79);
		...
		JLabel lblFelttel = new JLabel("Kitev\u0151:");
		lblFelttel.setBounds(6, 12, 36, 16);
		...
		spinnerKitevo.setBounds(54, 6, 110, 28);
		...
		lblItercisVltoz.setBounds(6, 51, 36, 16);
		...
		spinnerAlap.setBounds(54, 46, 110, 28);
	...
	KeyAdapter MindenKomponensKeyadapter = new KeyAdapter()
	{
		...
		public void keyReleased(KeyEvent arg0)
		{
			...
			else if(arg0.getKeyCode() == KeyEvent.VK_ENTER)
			{
				...
				try
				{
					String s = ((JSpinner.DefaultEditor) (((JSpinner) spinnerKitevo).getEditor())).getTextField().getText();
					...
					if(((SpinnerNumberModel) spinnerKitevo.getModel()).getMaximum() != null && ertekKit > (double) ((SpinnerNumberModel) spinnerKitevo.getModel()).getMaximum())
					{
						spinnerKitevo.setValue(((SpinnerNumberModel) spinnerKitevo.getModel()).getMaximum());
					}
					else if(((SpinnerNumberModel) spinnerKitevo.getModel()).getMaximum() != null && ertekKit < (double) ((SpinnerNumberModel) spinnerKitevo.getModel()).getMinimum())
					{
						spinnerKitevo.setValue(((SpinnerNumberModel) spinnerKitevo.getModel()).getMinimum());
					}
					else if(((SpinnerNumberModel) spinnerAlap.getModel()).getMaximum() != null && ertekAl > (double) ((SpinnerNumberModel) spinnerAlap.getModel()).getMaximum())
					{
						spinnerAlap.setValue(((SpinnerNumberModel) spinnerAlap.getModel()).getMaximum());
					}
					else if(((SpinnerNumberModel) spinnerAlap.getModel()).getMaximum() != null && ertekAl < (double) ((SpinnerNumberModel) spinnerAlap.getModel()).getMinimum())
					{
	...
	void Generalas()
	{
		...
		String beillesztendo = "Hatvány(" + String.format("%.0f",spinnerAlap.getValue()) + ", " + String.format("%.0f",spinnerKitevo.getValue()) + ")";
